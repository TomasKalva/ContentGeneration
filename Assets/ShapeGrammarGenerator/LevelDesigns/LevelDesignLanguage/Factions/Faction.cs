...
namespace Assets.ShapeGrammarGenerator.LevelDesigns.LevelDesignLanguage.Factions
{
    ...
    class FactionEnvironment
    {
        ...
        public ProgressFactory<ItemState> CreateItemFactory()
        {
            ...
            var effectByUser = Concepts.Effects.GetRandom()(faction);
            var selectorByUser = Concepts.Selectors.GetRandom();
            ...
            return envProgress =>
            {
                ...
                {
                    Name = "Procedurally generated item",
                    Description = "I have been procedurally generated by faction generator."
                }
                    .OnUse(ch => 
                    {
    ...
    class FactionConcepts
    {
        ...
        public List<EffectByFactionByUser> Effects { get; }
        public List<SelectorByUser> Selectors { get; }

        public FactionConcepts(List<Func<ProductionList>> productionLists, List<Func<CharacterState>> characterStates, List<EffectByFactionByUser> effects, List<SelectorByUser> selectors)
        {
